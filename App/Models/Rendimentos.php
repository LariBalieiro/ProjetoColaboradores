    ...
    public function getTodos($funcionarioCodigo, $limit = 10, $offset = 0) {
        ...
        $stmt = $this->db->prepare("
            ...
            INNER JOIN funcionario 
                ON Funcionario_Codigo = Rendimentos_Funcionario_Codigo
            WHERE Rendimentos_Funcionario_Codigo = :Funcionario_Codigo
            ORDER BY STR_TO_DATE(Rendimentos_Data, '%m/%Y') DESC
