...
class ComissaoController extends Action {
    ...
    public function index() {
        ...
        $this->view->comissaos = $comissaoModel->getTodos($funcionarioCodigo, $limite, $offset);
        $this->view->total = $comissaoModel->getTotal($funcionarioCodigo);
